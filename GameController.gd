...
@export var duck_fly_in_time := 0.5
@export var duck_flying_time := 3.0
@export var duck_fly_out_time := 0.5
...
func _fly_in_duck() -> void:
	...
	await get_tree().create_timer(duck_fly_in_time).timeout
	_flying_duck()
...
func _fly_out_duck() -> void:
	...
	await get_tree().create_timer(duck_fly_out_time).timeout
